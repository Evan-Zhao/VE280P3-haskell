...
/* package p3-0.1.0.0 */
#define VERSION_p3 "0.1.0.0"
#define MIN_VERSION_p3(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "p3-0.1.0.0-7zhqcF8ucC8K7MXm5xR8Ti"

#define CURRENT_PACKAGE_KEY "p3-0.1.0.0-7zhqcF8ucC8K7MXm5xR8Ti"
